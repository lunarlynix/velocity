              ...
              <ul className="text-sm">
                <li>
                  ...
                  >
                    ...
                    <span><span className="font-medium text-slate-800 group-hover:text-white">Article</span> - Solar Storm Warning issued for 31 March</span>
                  </a>
                </li>
                <li>
                  <a
                  ...
                  >
                    ...
                    <span><span className="font-medium text-slate-800 group-hover:text-white">Article</span> - Russia Conflict affecting ISS</span>
                  </a>
                </li>
              </ul>
            </div>
